...
const AboutSection = () => {
  ...
  const skills = [
    ...
    },
    {
      ...
      logo: (
        <svg viewBox="0 0 24 24" className="w-8 h-8">
          <circle fill="#0073aa" cx="12" cy="12" r="12"/>
    ...
    },
    {
      ...
      logo: (
        <svg viewBox="0 0 24 24" className="w-8 h-8">
          <path fill="#ff6b6b" d="M12 2L13.09 7.26L18 4L15.09 8.74L21 9L16.74 12L21 15L15.09 15.26L18 20L13.09 16.74L12 22L10.91 16.74L6 20L8.91 15.26L3 15L7.26 12L3 9L8.91 8.74L6 4L10.91 7.26L12 2Z"/>
          <circle fill="#4ecdc4" cx="12" cy="12" r="4"/>
          <path fill="#45b7d1" d="M12 8L14 10L12 12L10 10L12 8Z"/>
          <path fill="#96ceb4" d="M12 12L14 14L12 16L10 14L12 12Z"/>
        </svg>
      )
    }
  ];
