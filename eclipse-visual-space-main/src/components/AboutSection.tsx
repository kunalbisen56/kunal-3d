...
const AboutSection = () => {
  ...
  return <section ref={sectionRef} id="about" className="py-20 px-6">
          ...
          <div ref={contentRef} className="space-y-8">
            ...
            <div ref={skillsRef} className="mt-12">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {skills.map((skill, index) => <div key={skill.name} className="skill-icon glass p-4 rounded-lg text-center hover:glow-primary transition-all duration-300 cursor-pointer group">
