          ...
          <div className="space-y-6">
            ...
            <div className="glass p-6 rounded-2xl">
              ...
              <div className="flex space-x-4">
                ...
                <a href="https://www.facebook.com/share/1ZYwmJPerT/" target="_blank" rel="noopener noreferrer" className="social-icon w-12 h-12 glass rounded-lg flex items-center justify-center hover:glow-primary transition-all duration-300 group">
                  <svg className="w-6 h-6 group-hover:scale-110 transition-transform duration-300" fill="currentColor" viewBox="0 0 24 24">
