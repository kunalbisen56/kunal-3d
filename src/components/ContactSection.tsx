          ...
          <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
            <div className="form-input">
              ...
              <input
                ...
                required
                className="w-full px-4 py-3 glass rounded-lg border border-muted/30 focus:border-primary/60 focus:outline-none focus:glow-primary transition-all duration-300 bg-transparent text-foreground placeholder-muted-foreground"
            ...
            <div className="form-input">
              ...
              <textarea
                ...
                onChange={handleInputChange}
                required
                className="w-full px-4 py-3 glass rounded-lg border border-muted/30 focus:border-primary/60 focus:outline-none focus:glow-primary transition-all duration-300 bg-transparent text-foreground placeholder-muted-foreground resize-none"
            ...
            <button
              type="submit"
              className="submit-btn w-full py-4 btn-glow rounded-lg font-medium tracking-wider pulse-glow"
            >
              Send Message
            </button>
          </form>
            ...
            <div className="glass p-6 rounded-2xl">
              ...
              <div className="flex space-x-4">
                <a
                  ...
                  className="social-icon w-12 h-12 glass rounded-lg flex items-center justify-center hover:glow-primary transition-all duration-300 group"
                >
